  ...
  <main class="flex-1 container mx-auto px-6 py-10 flex flex-col lg:flex-row gap-10">
    <section class="menu flex-1">
      ...
      <div class="flex items-center gap-4 mb-4">
        <input type="date" id="date_start" class="border rounded-lg px-3 py-2">
        <span class="text-gray-600">to</span>
        <input type="date" id="date_end" class="border rounded-lg px-3 py-2">
        <button id="filterBtn" class="bg-[#324149] text-white px-4 py-2 rounded-lg hover:bg-[#6e7a86] transition">Filter</button>
      </div>
      ...
      <div class="overflow-x-auto bg-white rounded-lg shadow">
        <table class="min-w-full table-auto">
          ...
          <tbody id="transactionList" class="bg-white divide-y divide-gray-200 text-center"></tbody>
          <tfoot id="transactionTotal" class="bg-gray-100 font-bold text-center"></tfoot>
        </table>
      </div>
    </section>
    ...
    <aside class="w-full lg:w-80 h-fit self-start bg-white rounded-2xl shadow-md border border-gray-200 p-6 lg:sticky lg:top-24">
      ...
      <button id="printTable" class="w-full bg-[#324149] text-white py-2 rounded hover:bg-[#6e7a86] transition">Print</button>
    </aside>
  </main>
